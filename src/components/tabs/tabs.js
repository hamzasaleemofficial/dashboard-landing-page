                ...
                <div className="col-lg-12">
                    ...
                    <ul className="nav nav-tabs" id="argoTabs" role="tablist">
                        <li className="nav-item">
                            <a className="nav-link active" id="nav-tab-1" data-toggle="tab" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="true"><GroupIcon></GroupIcon> Complete User Flows</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" id="nav-tab-2" data-toggle="tab" href="#tab-2" role="tab" aria-controls="tab-2" aria-selected="false"><DeveloperBoardIcon></DeveloperBoardIcon> Support for Plugins</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" id="nav-tab-3" data-toggle="tab" href="#tab-3" role="tab" aria-controls="tab-3" aria-selected="false"><FileCopyIcon></FileCopyIcon> Source Files</a>
                        </li>
                    </ul>
